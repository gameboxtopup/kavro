(async function(){
 ...
 document.getElementById("buyButton").onclick=e=>{e.preventDefault();const name=document.getElementById("packageName").textContent;if(name==="Select a card"){alert("Please select a Steam Gift Card first.");return;}localStorage.setItem("selectedProduct",JSON.stringify({product:PRODUCT_NAME,package:name,price:document.getElementById("packagePrice").textContent}));location.href="checkout.html";};
})();
